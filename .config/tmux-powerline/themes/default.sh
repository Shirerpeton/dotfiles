...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'#3c3836'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#bdae93'}
...
if [ -z $TMUX_POWERLINE_LEFT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info #bdae93 #1d2021" \
		#"hostname #bdae93 #1d2021" \
		#"ifstat 30 255" \
		#"ifstat_sys 30 255" \
...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117" \
		"date_day #3c3836 136" \
		"date #3c3836 136 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"time #3c3836 136 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
