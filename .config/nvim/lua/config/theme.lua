...
vim.api.nvim_set_hl(0, 'LineNr', { fg = gui03, bg = nil, ctermfg = cterm03, ctermbg = cterm01 })
vim.api.nvim_set_hl(0, 'SignColumn', { fg = gui03, bg = nil, ctermfg = cterm03, ctermbg = cterm01 })
...
vim.api.nvim_set_hl(0, 'CursorLine', { bg = nil, ctermbg = cterm01 })
vim.api.nvim_set_hl(0, 'CursorLineNr', { fg = gui05, bg = nil, ctermfg = cterm04, ctermbg = cterm01 })
